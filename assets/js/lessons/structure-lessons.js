...
export const structureLessons = {
  "code-structure": {
    ...
    sections: [
      ...
      {
        title: "Group code by responsibility",
  ...
  functions: {
    ...
    sections: [
      ...
      },
      {
        ...
        note: { title: "Duplication is a signal", body: "Whenever two similar operations appear at different locations, consider making a function out of that code and reuse it where you took it from." },
      },
      {
  ...
  "parameters-arguments": {
    ...
    sections: [
      {
        title: "Definitions create input slots",
  ...
  "return-values": {
    ...
    sections: [
      ...
      {
        title: "One object can hold a complete result",
        ...
        note: { title: "Absence needs a policy", body: "If a search finds nothing, decide whether the function returns nothing, an empty collection, a result object, or an error. Document that choice so other people, and you months later, can understand what the code promises." },
      },
    ],
  ...
  lambdas: {
    ...
    title: "Lambdas are small unnamed functions",
  ...
  objects: {
    ...
    sections: [
      ...
      },
      {
        ...
        note: { title: "This is OOP", body: "Object-oriented programming, usually called OOP, organizes code around objects and classes. A class-centered style creates most objects from class definitions. This lesson mainly uses the familiar class approach found in Java, C#, and Python. JavaScript, Lua, C++, and other languages can organize objects differently, but the basic ideas still transfer." },
      },
      {
  ...
  methods: {
    ...
    sections: [
      ...
      },
      {
        ...
        note: { title: "Keep questions predictable", body: "A method that sounds like a question should not secretly make an unrelated change. Clear contracts make call sites easier to trust." },
      },
      {
    ...
    sections: [
      {
        ...
        note: { title: "A selected method can become a callback", body: "Selecting a method without calling it lets some languages pass that action elsewhere. For example, <code>button.on_press(counter.add_one)</code> gives the button a method to call later whenever it is pressed." },
      },
      {
  ...
  parentheses: {
    ...
    sections: [
      ...
      },
      {
        ...
        note: { title: "Flatten when debugging", body: "Intermediate names reveal the value at each step, make errors easier to locate, and make the code easier to follow. Do not be afraid to use more lines. Line count is not a quality score, and 60 readable lines may be much easier to maintain than 30 compressed ones." },
      },
    ],
    challenge: { title: "Function or call?", prompt: "An event system asks what to run later. Should you give it <code>openDoor</code> or <code>openDoor()</code>? Explain.", solution: "Usually give it <code>openDoor</code>, the function value. <code>openDoor()</code> runs immediately and supplies its returned value instead." },
